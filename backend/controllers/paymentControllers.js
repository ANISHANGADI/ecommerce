...
const stripe = Stripe('sk_test_51OlsMCSDIy3Oe4374hYAErm0ccKC4dHDz32ZGUnM9BAK4Lb9HN8iDJRliUYshhnUQ8LJhvRErEq31im4maV1ax7b00TwUkFAjt');
  ...
  const address = body?.address;
    const line_items = body?.orderItems?.map((item) => {
      return {
        ...
        tax_rates: ["txr_1OltOmSDIy3Oe437bkyfFunz"],
    ...
    const shippingInfo = {
      ...
      name: customerName,
      address: address,
      // Include other shipping info if available
    ...
    const shipping_rate =
      body?.itemsPrice >= 200
        ? "shr_1OlsdxSDIy3Oe437OGBGGM22"
        : "shr_1OltKwSDIy3Oe4371ZMaNBVl";
